...
//
//  // if(nbPing == lastPing+1 && (msgReceived1 == false || msgReceived2 == false || msgReceived3 == false))
...
void masterBuoyLoop(void * parameter){ 
  ...
  localAddress(WiFi.macAddress(), sizeof(WiFi.macAddress()));
